...
func (bq *BlogQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (bq *BlogQuery) FirstIDX(ctx context.Context) int64 {
...
func (bq *BlogQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (bq *BlogQuery) OnlyIDX(ctx context.Context) int64 {
...
func (bq *BlogQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (bq *BlogQuery) IDsX(ctx context.Context) []int64 {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bq *BlogQuery) ForUpdate(opts ...sql.LockOption) *BlogQuery {
...
func (bq *BlogQuery) ForShare(opts ...sql.LockOption) *BlogQuery {
	if bq.driver.Dialect() == dialect.Postgres {
		bq.Unique(false)
	}
	bq.modifiers = append(bq.modifiers, func(s *sql.Selector) {

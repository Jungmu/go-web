...
func (cq *CommentQuery) QueryOwner() *BlogQuery {
...
func (cq *CommentQuery) WithOwner(opts ...func(*BlogQuery)) *CommentQuery {
	query := &BlogQuery{config: cq.config}
...
func (cq *CommentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Comment, error) {
	...
	if query := cq.withOwner; query != nil {
		if err := cq.loadOwner(ctx, query, nodes, nil,
			func(n *Comment, e *Blog) { n.Edges.Owner = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (cq *CommentQuery) loadOwner(ctx context.Context, query *BlogQuery, nodes []*Comment, init func(*Comment), assign func(*Comment, *Blog)) error {
